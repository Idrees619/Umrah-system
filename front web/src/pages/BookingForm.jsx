                  ...
                  <table style={{fontSize:11}}>
                    <thead>
                      <tr>
                        ...
                        <th style={{width:85}}>نوع الحركة</th>
                        <th style={{width:95}}>التاريخ</th>
                        <th style={{width:65}}>الوقت</th>
                        <th style={{width:85}}>من (مدينة)</th>
                        <th style={{width:85}}>إلى (مدينة)</th>
                        <th style={{width:140}}>الفندق / الموقع من</th>
                        <th style={{width:140}}>الفندق / الموقع إلى</th>
                        <th style={{width:80}}>رقم الرحلة</th>
                        <th style={{width:45}}>باصات</th>
                        <th style={{width:70}}>الحالة</th>
                    ...
                    <tbody>
                      {steps.map((s,idx)=>(
                        <tr key={idx} style={{borderRight:`2.5px solid ${TCLR[s.movement_type]||'var(--border)'}`}}>
                          ...
                          <td>
                            <select value={s.movement_type} onChange={e=>upd(idx,'movement_type',e.target.value)} style={{width:'100%',fontSize:11,padding:'3px 4px'}}>
                          ...
                          <td>
                            <select value={s.from_city||''} onChange={e=>upd(idx,'from_city',e.target.value)} style={{width:'100%',fontSize:11,padding:'3px 4px'}}>
                          ...
                          <td>
                            <select value={s.status||'مجدول'} onChange={e=>upd(idx,'status',e.target.value)} style={{width:'100%',fontSize:10,padding:'3px 2px'}}>
                              {['مجدول','جاري','منتهي','ملغي','تحتاج-مراجعة'].map(ss=><option key={ss}>{ss}</option>)}</select>
                          </td>
                          <td>
